...
(defun transparency (value)
   "Set the transparency of the frame window.  VALUE of 0=transparent/100=opaque."
...
;; Set our browser to use.
(setq gnus-button-url 'browse-url-generic
          browse-url-generic-program "~/bin/callbrowser.sh"
...
(use-package doom-themes
  ...
  (load "~/.emacs.d/external/ef-themes/ef-themes.el")
...
(use-package mermaid-mode
  :straight t
  :bind (;; C-c C-d bindings (mode-specific-map)
